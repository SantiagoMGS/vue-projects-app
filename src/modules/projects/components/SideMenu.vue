<template>
  <aside class="bg-base-200 w-72 min-h-screen">
    <RouterLink to="/"> <h2 class="text-lg font-bold mx-4">Proyectos</h2> </RouterLink>
    <p v-if="projectsStore.noProjects" clas="text-sm text-gray-500 mx-4">No hay proyecctos</p>
